    ...
    public class LobbyManager : Singleton<LobbyManager>
    {
            ...
            options.Data = new Dictionary<string, DataObject>
        {
               ...
               },
               {
                   "bots",new DataObject(
                    visibility: DataObject.VisibilityOptions.Public,
                    value: lobbyParameters.botCount.ToString()) //Bot count. Not indexed.
               },
               {
                   "laps",new DataObject(
                    visibility: DataObject.VisibilityOptions.Public,
                    value: lobbyParameters.lapCount.ToString()) //Laps count. Not indexed.
               }
        };
        ...
        public bool TryGetLobbyParameter(string key, out string result)
        {
            if (dataControl.currentLobby != null && dataControl.currentLobby.Data.TryGetValue(key, out DataObject resultDataObject))
            {
                result = resultDataObject.Value;
                return true;
            }
